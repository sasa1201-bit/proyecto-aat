...
if total_tasks > 0:
    ...
    with grafica_col1:
        ...
        # Ahora la gráfica cuenta los tipos de tareas automáticamente con Pandas
...
with col_left:
    st.markdown("### 📝 Listado Actual de Tareas (¡Doble clic para cambiar Tipo, Estado o Prioridad!)")
    
    # Habilitamos la edición interactiva de la nueva columna en la tabla
