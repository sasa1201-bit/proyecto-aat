...
with tab1:
    ...
    if len(busqueda) >= 3:
        res = requests.get(f"https://v3.football.api-sports.io/teams?search={busqueda}", headers={'x-apisports-key': "acb867b68f5987d9c226e48c12c090e3", 'x-rapidapi-host': 'v3.football.api-sports.io'})
    ...
    res_fix = requests.get(f"https://v3.football.api-sports.io/fixtures?team={st.session_state.id}&season=2026", headers={'x-apisports-key': "acb867b68f5987d9c226e48c12c090e3", 'x-rapidapi-host': 'v3.football.api-sports.io'})
...
with tab2:
    ...
    res_live = requests.get("https://v3.football.api-sports.io/fixtures?live=all", headers={'x-apisports-key': "acb867b68f5987d9c226e48c12c090e3", 'x-rapidapi-host': 'v3.football.api-sports.io'})
...
# PESTAÑA 3: GRÁFICAS (Como estaban antes)
with tab3:
    st.subheader("📈 Analítica de Volumen")
    st.bar_chart(pd.DataFrame({'Partidos': [12, 5, 8]}, index=['Liga España', 'Liga MX', 'Premier League']))
