...
with tab3:
    ...
    gp_seleccionado = st.selectbox("Selecciona un Gran Premio:", nombres_gps, key="selector_gp_simple_v3_track_original")
    ...
    with col_track:
        ...
        st.markdown("<div style='background: rgba(15, 23, 42, 0.6); border: 1px solid rgba(56, 189, 248, 0.2); padding: 15px; border-radius: 12px; height: 300px; display: flex; align-items: center; justify-content: center;'>", unsafe_allow_html=True)
        st.image(track_url, use_container_width=True)
        st.markdown("</div>", unsafe_allow_html=True)
    ...
    with col_sel_p:
        piloto_filtro = st.selectbox("🎯 Explora el desempeño individual por Piloto:", ganadores_disponibles, key="select_filtro_piloto_victorias_pro_interactive_map_v3")
