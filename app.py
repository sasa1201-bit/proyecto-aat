...
def render_apple_style_calendar_ui():
    ...
    st.write("Selecciona el mes que deseas visualizar en la cuadrícula interactiva con los Grandes Premios mapeados directamente en sus fechas:")
    ...
    mes_seleccionado_num = st.selectbox("Seleccionar Mes:", options=list(meses_nombres.keys()), format_func=lambda x: meses_nombres[x], index=2)
